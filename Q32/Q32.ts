...
let current_users:string[] =['Saba Chohan', 'FaRyal KHan', 'Qirat Malik','hira hayat', 'sundal Khz', 'SundaS'];

//list of new users
let new_users:string[] = [ 'Anam khan','Hira Hayat', 'fiza malik', 'SUNDAS', 'Maha Ali'];
