...
let aLine :string = 'Peace Upon You.'; //in title case
let bLine :string = 'peace upon you.';  // in lower case
...
let item:string[] = ['pin', 'pen', 'pot', 'hit', 'het', 'hot'];
let count:number[] = [1, 3, 5, 6, 7, 9];
